            ...
            <div className="contact_information">
                <div className="information_header">
                    ...
                    <div className="information_get_touch">
                        ...
                        <p>If you have any question, or you need me for some work, don't hesitate to contact me here.</p>
                    </div>
                </div>
                <form onSubmit={handleSend.bind(this)}>
                    ...
                    <div className="textarea-container">
                        <textarea name="message" placeholder="Your Message" minLength={5} maxLength="350" value={message} onChange={(e)=> setMessage(e.target.value)}></textarea>
                        <motion.label className='message-length' htmlFor="message"
                        animate={controls}
                        style={{ color: mapRemainingToColor(charRemains) }}>{charRemains}</motion.label>
                    </div>
